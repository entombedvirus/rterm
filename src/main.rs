...
fn main() -> anyhow::Result<()> {
    ...
    let mut app = TerminalEmulator::new(&egui_glow.egui_ctx).context("app creation failed")?;
        ...
        let mut redraw = || {
...

            {
                unsafe {
                    ...
                    let color: Rgba = app.clear_color().into();
...
impl GlutinWindowContext {
    unsafe fn new(window_target: &EventLoopWindowTarget<UserEvent>) -> Self {
